...
class Follower:
    ...
    def __init__(self):
        ...
        self.pose_sub = rospy.Subscriber("/iris_1/mavros/local_position/pose", PoseStamped, self.pose_callback, queue_size=1)
        self.pose_enu_pub = rospy.Publisher("/iris_1/mavros/setpoint_position/local", PoseStamped, queue_size=1)#发布东北天下的控制命令;Twist是指的线速度和角速度
        self.arming_client_srv = rospy.ServiceProxy("/iris_1/mavros/cmd/arming", CommandBool)
        self.set_FCU_mode_srv = rospy.ServiceProxy("/iris_1/mavros/set_mode", SetMode)
    ...
    def loop(self):
        ...
        self.targetPose.pose.position.z=11.3
