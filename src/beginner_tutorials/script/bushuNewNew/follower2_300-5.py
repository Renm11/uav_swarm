...
class Follower_uav(object):
    ...
    def target_formation(self):
        ...
        if self.cmd_leader_avoid[0][0] == 4:
        ...
        self.cmd_vel_enu.twist.linear.y = self.Kp * ((self.leaderPose[1] + self.origin_formation[1] - 2 - self.pose.pose.position.y))  #-2是为了转换为本地坐标系
